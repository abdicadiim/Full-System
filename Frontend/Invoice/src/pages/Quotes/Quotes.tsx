        ...
        >
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              ...
              <button
                className="h-9 px-3 border border-gray-200 bg-white rounded-md hover:bg-gray-50 hover:border-gray-300 transition-all shadow-sm flex items-center justify-center"
            ...
            <div className="relative" ref={moreMenuRef}>
              ...
              {isMoreMenuOpen && (
                <div className="absolute top-full right-0 mt-2 w-56 bg-white border border-gray-200 rounded-lg shadow-xl z-[110] py-2 animate-in fade-in slide-in-from-top-2 duration-200">
                  ...
                  <button
                    onClick={refreshData}
                    className="w-full text-left px-4 py-2 text-sm text-gray-700 transition-colors flex items-center gap-3"
                  >
