        ...
        <body>
          ${selectedQuoteData.map(q => `
            <div class="quote-export">
              <div class="header">
                <h1>${organizationProfile?.organizationName || organizationProfile?.name || 'Organization'}</h1>
                <p>Quote Document</p>
              </div>
          ...
          `).join('')}
          <div class="footer">
            Generated by ${organizationProfile?.organizationName || organizationProfile?.name || 'Organization'} on ${new Date().toLocaleDateString()}
          </div>
        </body>
        </html>
      `);
  ...
  const handleViewQuoteInNewPage = () => {
    ...
    printWindow.document.write(`
      ...
      <body>
        ...
        <div class="footer">
          <p>Generated by ${organizationProfile?.organizationName || organizationProfile?.name || 'Organization'} on ${new Date().toLocaleDateString()}</p>
      ...
      <div className="w-full h-[calc(100vh-4rem)] min-h-0 flex bg-[#f8fafc] overflow-hidden">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="flex items-center gap-2 md:gap-4">
              ...
              <div className="min-w-0">
                <div className="text-sm text-gray-600 truncate">
                  Location: <span className="text-[#2F80FF]">{quote.selectedLocation || quote.location || "Head Office"}</span>
                </div>
          ...
          <div className="flex flex-wrap items-center gap-1.5 p-2 md:p-3 border-b border-gray-200 bg-[#f8fafc]">
            ...
            <button className="flex items-center gap-1.5 px-2 py-1.5 bg-transparent text-gray-700 rounded-md text-sm font-medium cursor-pointer hover:text-[#2F80FF]" onClick={handleShare}>
              <Share2 size={16} />
              <span>Share</span>
            </button>
            ...
            {(isDraftStatus || isSentStatus || isAcceptedStatus) && (
              <button
                className="flex items-center gap-1.5 px-2 py-1.5 bg-transparent text-gray-700 rounded-md text-sm font-medium cursor-pointer hover:text-[#2F80FF]"
                onClick={handleConvertToInvoice}
              >
          ...
          {activeTab === "details" && (
            <div className="flex-1 p-2 md:p-3 bg-gray-50 overflow-y-auto">
              {showPdfView && (
                (String(quote?.status || "").toLowerCase() === "invoiced" ||
                  String(quote?.status || "").toLowerCase() === "converted" ||
