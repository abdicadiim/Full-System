...
const CUSTOMER_QUERY_WARMUP_SESSION_KEY = "invoice_customer_query_warmup_v1";
const LEGACY_CUSTOMER_QUERY_WARMUP_SESSION_KEY = "billing_customer_query_warmup_v1";
...
export default function CustomerQueryWarmup() {
  ...
  useEffect(() => {
    ...
    const hasWarmedUp =
      sessionStorage.getItem(CUSTOMER_QUERY_WARMUP_SESSION_KEY) === "1" ||
      sessionStorage.getItem(LEGACY_CUSTOMER_QUERY_WARMUP_SESSION_KEY) === "1";
