import type { PhoneCodeOption } from "./customerDetailTypes";

export const TRANSACTION_SECTION_OPTIONS = [
...
export const CALENDAR_DAYS_OF_WEEK = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"];
