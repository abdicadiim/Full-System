...
type ExceptionColumn = "Date" | "Entry#" | "Description" | "Reason" | "User";
type DateRangeKey = "this-month" | "last-month" | "this-quarter" | "this-year";

const EXCEPTION_COLUMNS: ColumnGroup[] = [
  {
    label: "Exception Columns",
    items: ["Date", "Entry#", "Description", "Reason", "User"],
  },
];
...
export default function ExceptionReportPage() {
  ...
  const [selectedColumns, setSelectedColumns] = useState<ExceptionColumn[]>([
    "Date",
    "Entry#",
    "Description",
    "Reason",
  ...
  const refreshReport = () => {
    ...
    toast.success("Report refreshed: Exception Report");
  };
  ...
  const handleExport = (format: string) => {
    setIsExportOpen(false);
    toast.info(`Exporting Exception Report as ${format}`);
  };
  ...
  return (
    <div className="relative min-h-[calc(100vh-64px)] bg-[#f5f7fc] pt-3">
      <ReportsDrawer
        open={isDrawerOpen}
        activeReportId="exception-report"
        ...
        <div className="p-3">
          <div className="overflow-hidden rounded-xl border border-[#d7dce7] bg-white">
            ...
            <div className="border-b border-[#eef2f7] px-4 py-10 text-center">
              ...
              <h2 className="mt-2 text-[22px] font-semibold text-[#0f172a]">Exception Report</h2>
      ...
      <ReportCustomizeColumnsModal
        ...
        availableGroups={EXCEPTION_COLUMNS}
        selectedColumns={selectedColumns}
        onClose={() => setIsCustomizeOpen(false)}
        onSave={(nextVisibleColumns) => {
          setSelectedColumns(nextVisibleColumns as ExceptionColumn[]);
