...
type PortalActivityColumn = "Date" | "Activity Details" | "Description";
type DateRangeKey = "this-month" | "last-month" | "this-quarter" | "this-year";

const PORTAL_ACTIVITY_COLUMNS: ColumnGroup[] = [
  { label: "Portal Activity Columns", items: ["Date", "Activity Details", "Description"] },
];
...
export default function PortalActivitiesReportPage() {
  ...
  const [selectedColumns, setSelectedColumns] = useState<PortalActivityColumn[]>([
    "Date",
    "Activity Details",
    "Description",
  ]);
  ...
  const refreshReport = () => {
    ...
    toast.success("Report refreshed: Portal Activities");
  };
  ...
  const handleExport = (format: string) => {
    setIsExportOpen(false);
    toast.info(`Exporting Portal Activities as ${format}`);
  };
  ...
  return (
    <div className="relative min-h-[calc(100vh-64px)] bg-[#f5f7fc] pt-3">
      <ReportsDrawer
        open={isDrawerOpen}
        activeReportId="portal-activities"
        ...
        <div className="p-3">
          <div className="overflow-hidden rounded-xl border border-[#d7dce7] bg-white">
            ...
            <div className="border-b border-[#eef2f7] px-4 py-10 text-center">
              ...
              <h2 className="mt-2 text-[22px] font-semibold text-[#0f172a]">Portal Activities</h2>
      ...
      <ReportCustomizeColumnsModal
        ...
        reportName="Portal Activities"
        availableGroups={PORTAL_ACTIVITY_COLUMNS}
        selectedColumns={selectedColumns}
        onClose={() => setIsCustomizeOpen(false)}
        onSave={(nextVisibleColumns) => {
          setSelectedColumns(nextVisibleColumns as PortalActivityColumn[]);
