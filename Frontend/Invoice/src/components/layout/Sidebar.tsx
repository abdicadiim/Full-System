...
function renderIcon(name) {
  ...
  switch (name) {
    ...
    case "customers":
      return <User {...lineIconProps} />;
    case "items":
      return <Briefcase {...lineIconProps} />;
    case "quotes":
      return <Calculator {...lineIconProps} />;
    case "invoices":
      return <FileText {...lineIconProps} />;
    case "sales-receipts":
      return <Receipt {...lineIconProps} />;
    case "recurring-invoices":
      return <Repeat {...lineIconProps} />;
    case "payment-links":
      return <Link2 {...lineIconProps} />;
    case "payments-received":
      return <ArrowDownToLine {...lineIconProps} />;
    case "credit-notes":
      return <FileMinus2 {...lineIconProps} />;
...
const routePermissionMap = {
  ...
  "/sales/sales-receipts": "sales",
  "/sales/credit-notes": "sales",
  "/sales/recurring-invoices": "sales",
  "/invoices": "sales",
  "/quotes": "sales",
