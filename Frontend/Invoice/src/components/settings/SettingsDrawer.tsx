...
const sections: SettingsSection[] = [
  {
    ...
    items: [
      ...
      { label: "Custom Domain", path: "/settings/custom-domain", icon: Grid3x3 },
      { label: "Locations", path: "/settings/locations", icon: Grid3x3 },
      { label: "Manage Subscription", path: "/settings/subscription", icon: CreditCard },
      ...
      { label: "Vendor Portal", path: "/settings/vendor-portal", icon: StickyNote },
    ],
  },
  {
    title: "Setup & Configurations",
    items: [
      { label: "General Preferences", path: "/settings/general", icon: Settings },
      { label: "Currencies", path: "/settings/currencies", icon: CreditCard },
      { label: "Opening Balances", path: "/settings/opening-balances", icon: Package },
  ...
  },
  {
    title: "Customization",
    items: [
      { label: "Transaction Number Series", path: "/settings/customization/transaction-number-series", icon: ScrollText },
      ...
      { label: "Reporting Tags", path: "/settings/customization/reporting-tags", icon: Layers },
      { label: "Web Tabs", path: "/settings/customization/web-tabs", icon: Grid3x3 },
    ],
  },
  {
    title: "Automation",
    items: [
      { label: "Workflow Rules", path: "/settings/workflow-rules", icon: Settings },
      { label: "Workflow Actions", path: "/settings/workflow-actions", icon: Settings },
      { label: "Workflow Logs", path: "/settings/workflow-logs", icon: Settings },
      { label: "Schedules", path: "/settings/schedules", icon: ScrollText },
    ],
  },
  {
    ...
    items: [
      ...
      { label: "Accountant", path: "/settings/accountant", icon: Grid3x3 },
      { label: "Projects", path: "/settings/projects", icon: Grid3x3 },
      { label: "Timesheet", path: "/settings/timesheet", icon: ScrollText },
      { label: "Inventory Adjustments", path: "/settings/inventory-adjustments", icon: Package },
      ...
      { label: "Recurring Expenses", path: "/settings/recurring-expenses", icon: ScrollText },
      { label: "Purchase Orders", path: "/settings/purchase-orders", icon: FileText },
      { label: "Bills", path: "/settings/bills", icon: FileText },
      { label: "Recurring Bills", path: "/settings/recurring-bills", icon: ScrollText },
      { label: "Payments Made", path: "/settings/payments-made", icon: CreditCard },
      { label: "Vendor Credits", path: "/settings/vendor-credits", icon: FileText },
    ],
  },
  {
    title: "More",
    items: [
      ...
      { label: "User Preferences", path: "/settings/user-preferences", icon: Settings },
      { label: "VAT", path: "/settings/vat", icon: FileText },
