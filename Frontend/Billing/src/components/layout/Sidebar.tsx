...
const SIDEBAR_MODULE_BY_PATH: Record<string, string[]> = {
  ...
  "/sales/subscriptions": ["subscriptions", "recurringInvoice"],
  "/sales/credit-notes": ["creditNote"],
  "/sales/debit-notes": ["debitNote"],
  "/payments/payment-links": ["paymentLinks"],
  "/expenses/recurring-expenses": ["recurringExpense"],
  "/products/plans": ["plansAddons"],
  "/products/addons": ["plansAddons"],
...
function isSidebarPathVisible(path: string, modulePreferences: Record<string, boolean>) {
  const moduleKeys = SIDEBAR_MODULE_BY_PATH[path];
  if (!moduleKeys?.length) return true;
  const configuredKey = moduleKeys.find((key) => typeof modulePreferences[key] === "boolean");
  if (!configuredKey) return true;
  return modulePreferences[configuredKey];
}
...
const routePermissionContextMap = {
  ...
  "/products/products": { module: "products", submodule: "Products" },
  "/products/products/new": { module: "products", submodule: "Products" },
  "/products/plans": { module: "products", submodule: "Plan" },
  "/products/addons": { module: "products", submodule: "Addon" },
  "/products/coupons": { module: "products", submodule: "Coupon" },
  "/products/pricing-widgets": { module: "products", submodule: "Pricing Widgets" },
  "/products/price-lists": { module: "products", submodule: "Price List" },
  ...
  "/payments/gateways": { module: "payments", submodule: "Payments" },
  "/expenses": { module: "expenses", submodule: "Expenses" },
  "/expenses/recurring-expenses": { module: "expenses", submodule: "Expenses" },
  "/time-tracking/projects": { module: "time-tracking", submodule: "Projects" },
  "/time-tracking/timesheet": { module: "time-tracking", submodule: "Projects" },
  "/time-tracking/approvals": { module: "time-tracking", submodule: "Projects" },
  "/time-tracking/customer-approvals": { module: "time-tracking", submodule: "Projects" },
  "/events": { module: "events", submodule: "Events" },
...
const getSubmenuIcon = (path) => {
  const map = {
    ...
    "/products/products/new": CirclePlus,
