...
export default function EditCurrencyModal({
  ...
  useEffect(() => {
    ...
    setCurrencyCode(label);
    setCurrencySymbol(String(currency?.symbol || ""));
    setCurrencyName(name);
    setDecimalPlaces(currency?.decimalPlaces ? String(currency.decimalPlaces) : "2");
    setFormat(currency?.format || "1,234,567.89");
    setIsBaseCurrency(Boolean(currency?.isBaseCurrency ?? currency?.isBase));
  }, [currency]);
 ...
 const currencyData: Record<string, { symbol: string; name: string; decimals: string; format: string }> = {
    "AFN": { symbol: "؋", name: "Afghani", decimals: "2", format: "1,234,567.89" },
    "ALL": { symbol: "L", name: "Lek", decimals: "2", format: "1,234,567.89" },
    "DZD": { symbol: "دج", name: "Algerian Dinar", decimals: "2", format: "1,234,567.89" },
    "EUR": { symbol: "€", name: "Euro", decimals: "2", format: "1.234.567,89" },
    "AOA": { symbol: "Kz", name: "Kwanza", decimals: "2", format: "1,234,567.89" },
    "XCD": { symbol: "$", name: "East Caribbean Dollar", decimals: "2", format: "1,234,567.89" },
    ...
    "AZN": { symbol: "₼", name: "Azerbaijani Manat", decimals: "2", format: "1,234,567.89" },
    ...
    "BDT": { symbol: "৳", name: "Taka", decimals: "2", format: "1,234,567.89" },
    "BBD": { symbol: "$", name: "Barbadian Dollar", decimals: "2", format: "1,234,567.89" },
    "BYN": { symbol: "Br", name: "Belarusian Ruble", decimals: "2", format: "1,234,567.89" },
    "BZD": { symbol: "$", name: "Belize Dollar", decimals: "2", format: "1,234,567.89" },
    "XOF": { symbol: "CFA", name: "West African CFA Franc", decimals: "0", format: "1,234,567" },
    "BTN": { symbol: "Nu.", name: "Ngultrum", decimals: "2", format: "1,234,567.89" },
    "BOB": { symbol: "Bs.", name: "Boliviano", decimals: "2", format: "1,234,567.89" },
    "BAM": { symbol: "KM", name: "Convertible Mark", decimals: "2", format: "1,234,567.89" },
    "BWP": { symbol: "P", name: "Pula", decimals: "2", format: "1,234,567.89" },
    ...
    "KHR": { symbol: "៛", name: "Riel", decimals: "2", format: "1,234,567.89" },
    ...
    "CNY": { symbol: "¥", name: "Renminbi (Yuan)", decimals: "2", format: "1,234,567.89" },
    ...
    "CRC": { symbol: "₡", name: "Costa Rican Colón", decimals: "2", format: "1,234,567.89" },
    ...
    "USD": { symbol: "$", name: "US Dollar", decimals: "2", format: "1,234,567.89" },
    "EGP": { symbol: "ج.م", name: "Egyptian Pound", decimals: "2", format: "1,234,567.89" },
    "ERN": { symbol: "Nfk", name: "Nakfa", decimals: "2", format: "1,234,567.89" },
    "SZL": { symbol: "E", name: "Lilangeni", decimals: "2", format: "1,234,567.89" },
    ...
    "MGA": { symbol: "Ar", name: "Malagasy Ariary", decimals: "2", format: "1,234,567.89" },
    ...
    "MRU": { symbol: "UM", name: "Mauritanian Ouguiya", decimals: "2", format: "1,234,567.89" },
    ...
    "MNT": { symbol: "₮", name: "Mongolian Tögrög", decimals: "2", format: "1,234,567.89" },
    ...
    "NIO": { symbol: "C$", name: "Nicaraguan Córdoba", decimals: "2", format: "1,234,567.89" },
    ...
    "OMR": { symbol: "ر.ع.", name: "Omani Rial", decimals: "3", format: "1,234,567.89" },
    ...
    "PYG": { symbol: "₲", name: "Paraguayan Guaraní", decimals: "0", format: "1,234,567" },
    "PEN": { symbol: "S/", name: "Peruvian Sol", decimals: "2", format: "1,234,567.89" },
    ...
    "QAR": { symbol: "ر.ق", name: "Qatari Riyal", decimals: "2", format: "1,234,567.89" },
    ...
    "RWF": { symbol: "FRw", name: "Rwandan Franc", decimals: "0", format: "1,234,567" },
    "WST": { symbol: "WS$", name: "Samoan Tala", decimals: "2", format: "1,234,567.89" },
    "SAR": { symbol: "ر.س", name: "Saudi Riyal", decimals: "2", format: "1,234,567.89" },
    "RSD": { symbol: "din", name: "Serbian Dinar", decimals: "2", format: "1,234,567.89" },
    ...
    "SBD": { symbol: "SI$", name: "Solomon Islands Dollar", decimals: "2", format: "1,234,567.89" },
    "SOS": { symbol: "SOS", name: "Somali Shilling", decimals: "2", format: "1,234,567.89" },
    ...
    "LKR": { symbol: "₨", name: "Sri Lankan Rupee", decimals: "2", format: "1,234,567.89" },
    ...
    "TJS": { symbol: "SM", name: "Tajikistani Somoni", decimals: "2", format: "1,234,567.89" },
    ...
    "TOP": { symbol: "T$", name: "Tongan Paʻanga", decimals: "2", format: "1,234,567.89" },
    "TTD": { symbol: "TT$", name: "Trinidad and Tobago Dollar", decimals: "2", format: "1,234,567.89" },
    ...
    "TMT": { symbol: "m", name: "Turkmenistani Manat", decimals: "2", format: "1,234,567.89" },
    ...
    "UYU": { symbol: "$U", name: "Uruguayan Peso", decimals: "2", format: "1,234,567.89" },
    "UZS": { symbol: "soʻm", name: "Uzbekistani Som", decimals: "2", format: "1,234,567.89" },
    "VUV": { symbol: "VT", name: "Vanuatu Vatu", decimals: "0", format: "1,234,567" },
    "VES": { symbol: "Bs.", name: "Venezuelan Bolívar", decimals: "2", format: "1,234,567.89" },
    ...
    "ZWL": { symbol: "Z$", name: "Zimbabwean Dollar", decimals: "2", format: "1,234,567.89" },
};
  const currencyCodes = Object.keys(currencyData).map(code => `${code} - ${currencyData[code].name}`);
  const parseCurrencyLabel = (value: string) => {
  ...
  useEffect(() => {
    ...
    const { code, name } = parseCurrencyLabel(currencyCode);
    if (!code) return;
    const info = currencyData[code];
    if (info) {
      setCurrencySymbol(info.symbol);
      setCurrencyName(info.name);
      setDecimalPlaces(info.decimals);
  ...
  return createPortal(
    ...
    >
      <div
        className="bg-white rounded-lg shadow-xl w-full max-w-md mx-4 mt-10 mb-10"
