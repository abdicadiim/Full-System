...
export default function ReportsRoutes() {
  return (
    <Routes>
      ...
      <Route path="purchases-expenses/billable-expense-details" element={<BillableExpenseDetailsReportPage />} />
      <Route path="taxes/tax-summary" element={<TaxSummaryReportPage />} />
      ...
      <Route path=":categoryId/billable-expense-details" element={<BillableExpenseDetailsReportPage />} />
      <Route path=":categoryId/tax-summary" element={<TaxSummaryReportPage />} />
