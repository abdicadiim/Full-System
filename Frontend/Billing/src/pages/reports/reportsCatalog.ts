...
export const REPORT_CATEGORIES: ReportCategory[] = [
  {
    ...
    name: "Sales Reports",
    description:
      "Track and analyze how much goods and services your business has sold during a particular period. These reports help you understand overall sales performance, identify which customers, plans, addons, items, and coupons drive growth, and evaluate salesperson performance so you can make better informed decisions.",
  },
  {
    id: "receivables",
  ...
  },
  {
    ...
    description: "Track retention trends, customer loyalty, and account health over time.",
  },
  {
    id: "mrr-arr",
    name: "MRR and ARR",
  ...
  },
  {
    id: "taxes",
    name: "Taxes Reports",
    description: "Review tax totals, tax compliance, and tax-related transaction activity.",
  },
  {
...
export const REPORTS: ReportDefinition[] = [
  {
    ...
    summary: "Breakdown of each customer and the total value of goods and services purchased by them in a tabular view.",
    howItHelps: "Identify your most valuable and frequent customers and use that insight to build loyalty programs or targeted discounts.",
    basis: "Accrual",
  ...
  },
  {
    ...
    categoryId: "sales",
    name: "Sales by Item",
    summary: "Breakdown of each item that was sold.",
    howItHelps: "Identify best-selling items, refine pricing, improve inventory planning, and create targeted promotions.",
    basis: "Accrual",
  ...
  },
  {
    ...
    categoryId: "sales",
    name: "Sales by Plan",
    summary: "Breakdown of each plan that was sold.",
    howItHelps: "Identify best-selling plans and refine pricing and packaging based on plan performance.",
    basis: "Accrual",
    source: "Invoices and Credit Notes",
  ...
  },
  {
    ...
    categoryId: "sales",
    name: "Sales by Addon",
    summary: "Detailed view of each addon purchased by your customers.",
    howItHelps: "Monitor addon performance and find cross-sell opportunities to optimize pricing and packaging.",
    basis: "Accrual",
    source: "Invoices and Credit Notes",
  ...
  },
  {
    id: "sales-by-coupon",
    categoryId: "sales",
    name: "Sales by Coupons",
    summary: "List of all coupons, along with quantity sold and total discount amount given.",
    howItHelps: "Understand how much discount your business has given and use that insight to manage promotions more effectively.",
    basis: "Accrual",
    source: "Invoices",
    functionSupport: support("filter", "customizeColumns", "sort", "schedule", "share", "export", "print", "custom"),
  },
  {
    ...
    summary: "Summary of sales made by each salesperson.",
    howItHelps: "Evaluate salesperson performance, identify top performers, and manage incentives or targets using data-backed decisions.",
    basis: "Accrual",
    source: "Invoices and Credit Notes",
    functionSupport: support("filter", "compare", "customizeColumns", "sort", "schedule", "share", "export", "print", "custom"),
  },
  {
    ...
    categoryId: "sales",
    name: "Sales Summary",
    summary: "Concise overview of the total sales made by your business on each day.",
    howItHelps: "Monitor overall sales performance day by day and spot sales trends without drilling into specific customers or items.",
    basis: "Accrual",
  ...
  {
    id: "revenue-retention-cohort",
    categoryId: "retention",
    name: "Revenue Retention Cohort",
    summary: "Cohort-based revenue retention across customer groups and billing periods.",
    howItHelps: "Measure how much revenue is retained after the first billing cycle.",
    functionSupport: support("filter", "group", "performance", "customizeColumns", "sort", "schedule", "share", "export", "print", "custom"),
  },
  {
    id: "revenue-retention-rate",
    categoryId: "retention",
    name: "Revenue Retention Rate",
    summary: "Revenue retained from existing customers over the selected period.",
    howItHelps: "Track whether recurring revenue is holding steady or declining.",
    functionSupport: support("filter", "compare", "performance", "schedule", "share", "export", "print", "custom"),
  },
  {
    id: "renewal-summary",
    categoryId: "retention",
    name: "Renewal Summary",
    summary: "Summary of renewed subscriptions, pending renewals, and expiry outcomes.",
    howItHelps: "See how many customers renewed successfully within the period.",
    functionSupport: support("filter", "group", "customizeColumns", "sort", "schedule", "share", "export", "print", "custom"),
  },
  {
    id: "renewal-failures",
    categoryId: "retention",
    name: "Renewal Failures",
    summary: "List of subscriptions that failed to renew and the reasons behind them.",
    howItHelps: "Spot churn risk early and improve recovery workflows.",
    functionSupport: support("filter", "group", "customizeColumns", "sort", "schedule", "share", "export", "print", "custom"),
  },
  {
    id: "subscription-retention-rate",
    categoryId: "retention",
    name: "Subscription Retention Rate",
    summary: "Subscription retention performance across cohorts and time windows.",
    howItHelps: "Track customer loyalty and subscription stickiness over time.",
    functionSupport: support("filter", "compare", "performance", "schedule", "share", "export", "print", "custom"),
  },
...

  {
    ...
    summary: "Customer payment speed distribution across aging buckets.",
    howItHelps: "See how quickly customers pay and spot accounts that need follow-up.",
...

  {
    ...
    categoryId: "taxes",
    name: "Tax Summary",
    summary: "Summary of taxes collected, paid, and outstanding for the selected period.",
    howItHelps: "Quickly review tax totals and compliance position in one view.",
    functionSupport: support("filter", "group", "customizeColumns", "sort", "schedule", "share", "export", "print", "custom"),
  },
  ...
  },
  {
    ...
    summary: "System exceptions, failures, and operational error events in one view.",
    howItHelps: "Spot recurring failures and investigate issues before they affect customers.",
    functionSupport: support("filter", "customizeColumns", "sort", "schedule", "share", "export", "print"),
  },
  {
