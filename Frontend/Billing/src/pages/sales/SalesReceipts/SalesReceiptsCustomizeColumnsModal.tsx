...
export type SalesReceiptsColumnOption = {
  key: string;
  label: string;
  locked?: boolean;
};
...
type Props = {
  open: boolean;
  columns: SalesReceiptsColumnOption[];
  value: string[];
  onClose: () => void;
  onSave: (nextVisibleColumns: string[]) => void;
};

const ensureLocked = (keys: string[], columns: SalesReceiptsColumnOption[]) => {
...
export default function SalesReceiptsCustomizeColumnsModal({
  open,
  columns,
  value,
  onClose,
